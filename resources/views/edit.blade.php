                    ...
                    <div class="container mt-5">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="user_birthdate" name="user_birthdate" value="{{ $user->user_birthdate}}"
                                    placeholder="Data de Nascimento" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="user_estadocivil">Estado Civil</label>
                                <input type="text" class="form-control" id="user_estadocivil" name="user_estadocivil" value="{{ $user->user_estadocivil}}"
                                    placeholder="Estado Civil" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="cep">CEP</label>
                                <input type="text" class="form-control" id="cep" name="cep" placeholder="CEP" value="{{ $user->cep}}"
                                    required>
                            </div>
