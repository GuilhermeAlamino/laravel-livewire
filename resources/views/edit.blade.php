                        ...
                        <div class="form-row mt-5">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('user_name') is-invalid @enderror"
                                    id="user_name" name="user_name" placeholder="Nome" value="{{ $user->user_name }}">
                                @error('user_name')
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control  @error('user_cpf') is-invalid @enderror"
                                    id="user_cpf" name="user_cpf" placeholder="CPF" value="{{ $user->user_cpf }}">
                                @error('user_cpf')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control  @error('user_rg') is-invalid @enderror"
                                    id="user_rg" name="user_rg" placeholder="RG" value="{{ $user->user_rg }}">
                                @error('user_rg')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control @error('cep') is-invalid @enderror" id="cep"
                                    name="cep" placeholder="CEP" value="{{ $user->cep }}">
                                @error('cep')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-9 mb-3">
                                ...
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                    id="address" name="address" placeholder="Endereço" value="{{ $user->address }}">
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('district') is-invalid @enderror"
                                    id="district" name="district" placeholder="Bairro" value="{{ $user->district }}">
                                @error('district')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('state') is-invalid @enderror"
                                    id="state" name="state" placeholder="Estado" value="{{ $user->state }}">
                                @error('state')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
